...
svn export https://github.com/kenzok8/small/branches/master/lua-neturl
svn export https://github.com/kiddin9/openwrt-packages/branches/master/lua-maxminddb
svn export https://github.com/kenzok8/openwrt-packages/branches/master/lua-maxminddb
